...
case "$choice" in
	"volume Control") /home/hakuTsuki/hakurenNixosConfig/resources/scripts/setVolume.sh ;;
	"wallpaper Switch") /home/hakuTsuki/hakurenNixosConfig/resources/scripts/changeBackground.sh ;;
